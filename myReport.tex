...
%\begin{figure*}
%<<my-label, eval=TRUE, fig.height=3, fig.width=7.5, echo=FALSE, dev='pdf'>>=
%set.seed(1213)  # for reproducibility
%x = cumsum(rnorm(100))
%plot(x, type = 'l')  # Brownian motion
%@
%\protect\caption{A simple plot of some Brownian motion.}
%\end{figure*}
...
\subsection{Subsection}
%\addcontentsline{toc}{subsection}{Subsection} % Adds this section to the table of contents
\lipsum[1] % Dummy text
\paragraph{Paragraph} \lipsum[1] % Dummy text
\paragraph{Paragraph} \lipsum[1] % Dummy text
